...
export default class Board {
    ...
    calculateAiMove (level) {
        const from = Object.keys(this.playingPlayer.moves)[Math.floor(Math.random() * Object.keys(this.playingPlayer.moves).length)]
        return { [from]: this.playingPlayer.moves[from][Math.floor(Math.random() * this.playingPlayer.moves[from].length)] }
    }
