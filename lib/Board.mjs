...
export default class Board {
    ...
    testMoveScores (from, to, playingPlayerColor, level, scoreTable) {
        ...
        if (level === 0) {
            ...
            testBoard.playingPlayer.color === playingPlayerColor
                ? score += testBoard.playingPlayer.getHighestValueAttackingPiece()
                : score -= testBoard.getNonPlayingPlayer().getHighestValueAttackingPiece()
