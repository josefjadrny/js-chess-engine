...
export default class Pawn extends Chessman {
    ...
    getMoves () {
        ...
        if (this.field.upLeft(this.color) &&
            ((!this.field.upLeft(this.color).isEmpty() && this.field.upLeft(this.color).chessMan.color !== this.color) ||
            (this.field.upLeft(this.color).location === this.board.enPassant))) {
            moves.push(this.field.upLeft(this.color).location)
        }

        if (this.field.upRight(this.color) &&
            ((!this.field.upRight(this.color).isEmpty() && this.field.upRight(this.color).chessMan.color !== this.color) ||
            (this.field.upRight(this.color).location === this.board.enPassant))) {
